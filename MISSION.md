...
- 목표: profile 페이지에 버튼 및 form이 실제로 작동되도록 JS 및 views, apis에 코드를 작성하고 연결
- 작업 범위:
  - profile 페이지에 프로필 정보 수정, 삭제, 비밀번호 수정 기능이 작동하도록 필요한 JS 및 API를 작성하고 views에 필요한 코드를 작성하여 실제로 기능들이 작동하도록 수정.
- 필요 기술: -
- 예상 작업 시간: 2시간
- 보수: 기프티콘 룰렛(배민 상품권, 치킨, 피자, 햄버거)
- 완료일: 2025-02-22
- 작업자: 동근님
