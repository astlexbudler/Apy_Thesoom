...
- 목표: 나머지 페이지들을 디자인하기 전에 사이트의 메인 페이지를 우선적으로 디자인하고 퍼블리싱하는 작업.
- 작업범위:
...
- 목표: 제작된 메인 페이지와 클라이언트 요청 사항을 바탕으로 나머지 페이지의 HTML을 작성하는 작업
- 작업범위:
  - 메인 페이지를 제외하고 나머지 페이지들에 대한 HTML 작성.
  - 정적 이미지 및 요소들을 사용해서 페이지를 디자인하고 퍼블리싱
  - 모달이나 Alert을 제외한 나머지 자바스크립트는 작성 불필요.
- 필요 기술: HTML, CSS, JavaScript / Django-Template
- 예상 작업 시간: 12시간
- 보수: 420,000원
- 완료일: -
