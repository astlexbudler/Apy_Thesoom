# Generated by Django 4.2.19 on 2025-02-19 13:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='연락처는 숫자만 입력 가능합니다.', regex='^\\d+$'), django.core.validators.MinLengthValidator(limit_value=7, message='연락처는 최소 7자리 이상이어야 합니다.')])),
